...
export function PageHeader({
  ...
  return (
    <div className="grid grid-cols-1 items-end gap-4 mb-8 sm:grid-cols-[minmax(0,1fr)_auto]">
      ...
      {actions && <div className="shrink-0 flex flex-wrap items-center gap-2 sm:justify-end">{actions}</div>}
    </div>
  );
}
